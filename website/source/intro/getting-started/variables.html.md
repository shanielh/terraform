...
We don't recommend saving usernames and password to version control, But you may create a local secret variables file to your computer and use `-var-file` to load it.

_Note :_ If you're managing multiple environments from the same terraform directory, You can use multiple `-var-file` statements. For example : 
